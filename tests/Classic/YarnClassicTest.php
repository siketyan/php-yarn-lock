...
class YarnClassicTest extends TestCase
{
    public function testPackages(): void
    {
        ...
        $this->assertSame('18.16.16', $packages[0]->getVersion());
        $this->assertSame('https://registry.yarnpkg.com/@types/node/-/node-18.16.16.tgz#3b64862856c7874ccf7439e6bab872d245c86d8e', $packages[0]->getResolvedUrl());
        $this->assertSame('sha512-NpaM49IGQQAUlBhHMF82QH80J08os4ZmyF9MkpCzWAGuOHqE4gTEbhzd7L3l5LmWuZ6E0OiC1FweQ4tsiW35+g==', $packages[0]->getIntegrity());
        ...
        $this->assertSame('5.0.4', $packages[1]->getVersion());
        $this->assertSame('https://registry.yarnpkg.com/typescript/-/typescript-5.0.4.tgz#b217fd20119bd61a94d4011274e0ab369058da3b', $packages[1]->getResolvedUrl());
        $this->assertSame('sha512-cW9T5W9xY37cc+jfEnaUvX91foxtHkza3Nw3wkoF4sSlKn0MONdkdEndig/qPBWXNkmplh3NzayQzCiHM4/hqw==', $packages[1]->getIntegrity());
