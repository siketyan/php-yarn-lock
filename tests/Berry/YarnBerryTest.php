...
class YarnBerryTest extends TestCase
{
    public function testPackages(): void
    {
        ...
        $this->assertSame('@types/node@npm:18.16.16', $packages[0]->getResolution());
        $this->assertSame('0efad726dd1e0bef71c392c708fc5d78c5b39c46b0ac5186fee74de4ccb1b2e847b3fa468da67d62812f56569da721b15bf31bdc795e6c69b56c73a45079ed2d', $packages[0]->getChecksum());
        ...
        $this->assertSame('npm', $constraint->getPrefix());

        $this->assertSame('typescript', $packages[1]->getName());
        $this->assertSame('5.0.4', $packages[1]->getVersion());
        $this->assertSame('typescript@npm:5.0.4', $packages[1]->getResolution());
        $this->assertSame('82b94da3f4604a8946da585f7d6c3025fff8410779e5bde2855ab130d05e4fd08938b9e593b6ebed165bda6ad9292b230984f10952cf82f0a0ca07bbeaa08172', $packages[1]->getChecksum());
        $this->assertCount(1, $packages[1]->getConstraints()->all());

        $constraint = $packages[1]->getConstraints()->first();
        $this->assertInstanceOf(Constraint::class, $constraint);
        $this->assertSame('^5', $constraint->getRange());
        $this->assertSame('npm', $constraint->getPrefix());
    }
}
